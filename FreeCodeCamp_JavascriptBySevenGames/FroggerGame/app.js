document.addEventListener('DOMContentLoaded', () => {
    ...
    const RIGHT_DIRECTION_KEY = 39;
    const UP_DIRECTION_KEY = 38;
    const LEFT_DIRECTION_KEY = 37;
    const DOWN_DIRECTION_KEY = 40;
    ...
    //move the frog when its on the log moving rigth
    ...
    //all the functions that move piece
